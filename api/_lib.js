...
const COOKIE_NAME = 'newmetals_session';
...
const IMAGE_DIR = 'assets/uploads/';
...
// public/assets/uploads/<slot>-<digits>.webp — no traversal, no arbitrary extensions.
function isAllowedImagePath(path) {
  return /^public\/assets\/uploads\/[a-z0-9-]+-\d+\.webp$/.test(path);
}
