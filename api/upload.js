...
// No fixed slot list: hero, about, mask, work-<id> (cover), gal-<id> (gallery), etc.
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const path = 'public/assets/uploads/' + filename;
    ...
    return res.status(200).json({ ok: true, path, url: '/assets/uploads/' + filename });
  } catch (e) {
